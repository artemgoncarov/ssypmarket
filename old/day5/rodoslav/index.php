...
<body>
    ...
    <template id="js-product-card">
        <div class="js-product-card">
            ...
            <img class="js-img" src="" alt="Картинка">
            <div class="js-price"></div><br>
        </div>
    </template>
    <button onclick="ochistit();" >Очистить корзину</button>
    
    <script>
        function ochistit(){
            localStorage.setItem('cart', "[]")
        }
        Api.post("./public/json/products.json").then((data) => {new ProductsComponent(document.body, data);});
    </script>
</body>
